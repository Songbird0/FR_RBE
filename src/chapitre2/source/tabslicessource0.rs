...
// Cette fonction emprunte -mais ne possède pas- une slice.
...
fn main() {
    ...
    let mut i: usize = 0;
    while(i < ys.len()){
    //Commentez cette ligne si vous ne souhaitez pas voir les éléments dans la console.
        println!("ys[{0}]={1}", &i, &ys[i]);
        i = i + 1;
    }
    ...
    // Les tableaux peuvent être automatiquement emprunté en tant que 
    // slice.
