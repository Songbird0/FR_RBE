...
Les valeurs "boxées" peuvent être déréférencées en utilisant l'opérateur `*`; Ceci supprime un [niveau d'indirection](https://stackoverflow.com/questions/18003544/what-does-level-of-indirection-mean-in-david-wheelers-aphorism/18003704#18003704 "Signification du terme 'indirection'").
